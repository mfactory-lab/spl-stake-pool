...
async function redelegate(props) {
    ...
    const sourceTransientStake = findTransientStakeProgramAddress(STAKE_POOL_PROGRAM_ID, sourceVoteAccount, stakePoolAddress, new BN__default["default"](sourceTransientStakeSeed));
    const destinationValidatorStake = findStakeProgramAddress(STAKE_POOL_PROGRAM_ID, destinationVoteAccount, stakePoolAddress);
    const destinationTransientStake = findTransientStakeProgramAddress(STAKE_POOL_PROGRAM_ID, destinationVoteAccount, stakePoolAddress, new BN__default["default"](destinationTransientStakeSeed));
    const ephemeralStake = findEphemeralStakeProgramAddress(STAKE_POOL_PROGRAM_ID, stakePoolAddress, new BN__default["default"](ephemeralStakeSeed));
    const instructions = [];
